...
stratified on a categorical variable, and the \texttt{summarizeNA} function
...
\label{sec:orgcb32924}

\subsection{Summary statistics}
\label{sec:orgd83f477}
...
\label{sec:org7153e8b}
\subsection{Classical covariance patterns}
\label{sec:org8d673af}
...
\label{sec:org5be23de}
\subsection{Full information approach}
\label{sec:org070f0d6}
...
\label{sec:orge93c370}

\subsection{nlme package}
\label{sec:org0697dac}
